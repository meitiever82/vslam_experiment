...
| cuvslam_ros | ⬜ | 🟢 2026-04-16 stereo VO, rectify_fisheye, APE 0.56m(122s段) | 🟢 2026-04-22 V101 **stereo-inertial** (odometry_mode=inertial, T_C0_IMU 修正): **APE SE3 0.237m / Sim3 0.228m** (vs stereo-only 0.467m, IMU 带 2×). 2876 poses, 144s, plumb_bob | ⬜ |
